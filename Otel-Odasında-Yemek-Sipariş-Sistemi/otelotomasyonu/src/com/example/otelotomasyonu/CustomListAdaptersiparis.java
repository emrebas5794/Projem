...
public class CustomListAdaptersiparis extends BaseAdapter {

	private ArrayList<NewsItemsiparis> listData;

	private LayoutInflater layoutInflater;

	public CustomListAdaptersiparis(Context context, ArrayList<NewsItemsiparis> listData) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		NewsItemsiparis newsItemsiparis = (NewsItemsiparis) listData.get(position);
