...
public partial class soru1 : System.Web.UI.Page
{
    ...
    class YeniSoruGetir
    {
        ...
        public string cevapd { get; set; }
        public string dogrucevap { get; set; }
        public string soran { get; set; }
        public string sira { get; set; }

        public YeniSoruGetir(string soruid, string soru, string cevapa, string cevapb, string cevapc, string cevapd, string dogrucevap, string soran, string sira)
        {
            this.soruid = soruid;
            this.soru = soru;
            this.cevapa = cevapa;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string kategori_id;
        if (Request.QueryString["YeniGuncelSorular"] == "true")
        {
            ...
            SqlCommand cmd = new SqlCommand("YeniGuncelSoruGetir", baglanti);
            ...
            List<YeniSoruGetir> im = new List<YeniSoruGetir>();
            SqlDataReader oku = cmd.ExecuteReader();
            ...
            while ((oku.Read()))
            {
                ...
                json = new YeniSoruGetir(oku["id"].ToString(), oku["soru"].ToString(), oku["cevapa"].ToString(), oku["cevapb"].ToString(), oku["cevapc"].ToString(), oku["cevapd"].ToString(), oku["dogrucevap"].ToString(), oku["soran"].ToString(), oku["sira"].ToString());
                im.Add(json);
