...
sifremiunuttum.setOnClickListener(new View.OnClickListener() {
		...
		grsbtn.setOnClickListener(new View.OnClickListener() {
        	public void onClick(View v) {
        		 ...
        		 String[] kullaniciadikontrol=edit_kullaniciadi.getText().toString().trim().split(" ");
        		 String[] kullanicisifrekontrol=edit_sifre.getText().toString().trim().split(" ");
        		 if(kullaniciadikontrol.length==1 && kullanicisifrekontrol.length==1)
        		 {
        		 url = "http://teknoem.com/bestebes/login.aspx?login=true&kullaniciadi="+kullaniciadikontrol[0]+"&sifre="+kullanicisifrekontrol[0]+"";
        		new JSONParse().execute();
        		 }
        		 else
        		 {
        			 Toast.makeText(getApplicationContext(),"Lüften Kullanýcý Adýnýz veya Þifrenizde Boþluk Olmasýn.", Toast.LENGTH_LONG).show(); 
        		 }
        		    }
        		   else
        		    {
    		 ...
    		 try {
    				...
    				// Storing  JSON item in a Variable
    				 ...
    				 if(deger.equals("true"))
    				 {
        				 ...
        				 tokenid= tokenid.substring(5,tokenid.length()-5);
